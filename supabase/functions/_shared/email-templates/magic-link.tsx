...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="pt" dir="ltr">
    <Head />
    <Preview>O seu link de acesso ao Saldo+</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Aceder à sua conta</Heading>
        <Text style={text}>
          Clique no botão abaixo para entrar no Saldo+. Este link expira em
          breve.
        </Text>
