...
export const EmailChangeEmail = ({
  ...
  <Html lang="pt" dir="ltr">
    <Head />
    <Preview>Confirme a alteração do seu email no Saldo+</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Pediu para alterar o email da sua conta Saldo+ de{' '}
        ...
        <Text style={footer}>
          Se não pediu esta alteração, proteja a sua conta imediatamente e
          contacte-nos.
        </Text>
